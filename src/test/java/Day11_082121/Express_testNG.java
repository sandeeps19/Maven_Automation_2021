...
public class Express_testNG {
    ...
    public void setTheDriverAndWorkbook() throws IOException, BiffException {
        ...
        readableFile = Workbook.getWorkbook(new File("src/main/resources/AI5.xls"));
        //create a writable file that mimics the readable in order to write back your result and not corrupt the readable
        writableFile = Workbook.createWorkbook(new File("src/main/resources/AI5_Results.xls"),readableFile);
