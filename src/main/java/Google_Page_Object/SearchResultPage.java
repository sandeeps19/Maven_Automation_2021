...
import Reusable_classes.Reusable_Annotations_Class_Htwl_Report;
...
public class SearchResultPage extends Reusable_Annotations_Class_Htwl_Report {
    ExtentTest logger;
    public SearchResultPage(WebDriver driver){
        PageFactory.initElements(driver,this);
        this.logger = Reusable_Annotations_Class_Htwl_Report.logger;
